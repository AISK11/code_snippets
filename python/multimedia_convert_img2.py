...
#  BMP  #
#########
def multimedia_convert_img_to_bmp(img_input, img_output=''.join(img_input.split(".")[:-1])+".bmp"):
...
def multimedia_convert_img_to_ico(img_input, img_output=''.join(img_input.split(".")[:-1])+".ico", img_size=256):
...
def multimedia_convert_img_to_jpg(img_input, img_output=''.join(img_input.split(".")[:-1])+".jpg", img_quality=95):
